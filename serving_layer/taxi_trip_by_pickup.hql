CREATE EXTERNAL TABLE shichen_taxi_trips_by_pickup_hive (
...
TBLPROPERTIES ("[hbase.table.name](http://hbase.table.name/)" = "shichen_taxi_trips_by_pickup");

INSERT OVERWRITE TABLE shichen_taxi_trips_by_pickup_hive
SELECT
